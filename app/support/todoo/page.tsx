...
const TRANSLATIONS: Record<Language, {
  ...
  ja: {
    ...
    aboutSupportText: "ToDooをご利用いただきありがとうございます。ご不明な点やお困りのことがございましたら、以下のよくある質問をご確認いただくか、お問い合わせください。",
    faq: "よくある質問",
    contactUs: "お問い合わせ",
  ...
  en: {
    ...
    aboutSupportText: "Thank you for using ToDoo. If you have any questions or issues, please check the FAQ below or contact us.",
    faq: "FAQ",
  ...
  fr: {
    ...
    aboutSupportText: "Merci d'utiliser ToDoo. Si vous avez des questions ou des problèmes, veuillez consulter la FAQ ci-dessous ou nous contacter.",
    ...
    backToHub: "Retour à la liste des apps",
  },
  de: {
    support: "Support",
    aboutSupport: "Über den Support",
    aboutSupportText: "Vielen Dank, dass Sie ToDoo verwenden. Bei Fragen oder Problemen lesen Sie bitte die FAQ unten oder kontaktieren Sie uns.",
    faq: "Häufige Fragen",
    contactUs: "Kontakt",
  ...
  ko: {
    support: "지원",
    aboutSupport: "지원 안내",
    aboutSupportText: "ToDoo을(를) 이용해 주셔서 감사합니다. 질문이나 문제가 있으시면 아래 FAQ를 확인하시거나 문의해 주세요.",
    faq: "자주 묻는 질문",
    contactUs: "문의하기",
  ...
  zh: {
    support: "支持",
    aboutSupport: "关于支持",
    aboutSupportText: "感谢您使用ToDoo。如果您有任何问题，请查看下面的常见问题或联系我们。",
    faq: "常见问题",
    contactUs: "联系我们",
...
// メインページ
// ========================================
export default function ToDooSupportPage() {
    ...
    <main className="min-h-screen py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <header className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2">ToDoo</h1>
      ...
      <footer className="border-t border-gray-200 py-8 mt-16">
        <div className="max-w-2xl mx-auto px-4 text-center text-sm text-gray-500">
          <p>© {currentYear} ToDoo. All rights reserved.</p>
        </div>
      </footer>
    </main>
  );
